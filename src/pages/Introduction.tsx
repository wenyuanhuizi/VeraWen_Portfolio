  ...
  return (
    <div className="section" style={{ paddingTop: 80 }}>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 16 }}>
          ...
          <div style={{
            ...
            <img src="/VeraWen_Portfolio/headshot.jpeg" style={{ width: '100%', height: '100%', objectFit: 'cover' }} alt="Vera Wen" />
            {/* Decorative ring */}
            <div style={{
      ...
      <div className="open-banner">
        ...
        <a href="mailto:wenyuanhuizi@gmail.com" className="btn btn-primary" style={{ marginLeft: 'auto', flexShrink: 0, background: '#059669' }}>
          Get in touch
        </a>
      </div>
